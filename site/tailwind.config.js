...
const config = {
    ...
    theme       : {
        ...
        extend  : {
            ...
            typography: (theme) => ({
                DEFAULT: {
                    css: {
                        color              : 'var(--fluyt-text-default)',
                        '[class~="lead"]'  : {
                            color: 'var(--fluyt-text-secondary)'
                        },
                        a                  : {
                            color: 'var(--fluyt-primary-500)'
                        },
                        strong             : {
                            color: 'var(--fluyt-text-default)'
                        },
                        ...
                        'ul > li::before'  : {
                            backgroundColor: 'var(--fluyt-text-hint)'
                        },
                        hr                 : {
                            borderColor: 'var(--fluyt-border)'
                        },
                        blockquote         : {
                            color          : 'var(--fluyt-text-default)',
                            borderLeftColor: 'var(--fluyt-border)'
                        },
                        h1                 : {
                            color: 'var(--fluyt-text-default)'
                        },
                        ...
                        thead              : {
                            color            : 'var(--fluyt-text-default)',
                            borderBottomColor: 'var(--fluyt-border)'
                        },
                        'tbody tr'         : {
                            borderBottomColor: 'var(--fluyt-border)'
                        },
    ...
    plugins     : [
        ...
        // Fluyt - Tailwind plugins
        require(path.resolve(__dirname, ('src/core/tailwind/plugins/extract-config'))),
        ...
        require(path.resolve(__dirname, ('src/core/tailwind/plugins/theming')))({themes}),
