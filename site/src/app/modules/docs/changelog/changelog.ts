        ...
        // v13.6.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(core/drawer) Final opacity of the overlay is not permanent due to player being destroyed right after the animation'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(core/theming) Better structuring on the themes.scss file',
                        '(core) Disabled Angular Material "theme" sanity check since we use "all-component-themes" without a color map',
                        '(apps/mailbox) Style improvements',
                        'Removed empty "styles" from component decorators',
                        'Decreased budget sizes since new Fluyt is a lot smaller compared to the one with the old design'
                    ]
                },
                {
                    type: 'Fixed',
                    list: [
                        '(core/overrides) Quill editor is not styled correctly by default',
                        '(core/confirmation) Dialog size cannot be updated using dialogRef\'s "updateSize" method',
            ...
            changes    : [
                {
                    type: 'Fixed',
                    list: [
                        '(fluyt/confirmation) Confirmation dialog colors are not optimized for the Dark mode'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(fluyt/confirmation) A service to quickly configure and show confirmation dialogs'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(apps/contacts) Added confirmation to the "Delete contact" action using FluytConfirmationService',
                        '(apps/ecommerce/inventory) Added confirmation to the "Delete product" action using FluytConfirmationService',
                        '(apps/scrumboard) Added confirmation to the "Delete list" action using FluytConfirmationService',
                        '(apps/tasks) Added confirmation to the "Delete task" action using FluytConfirmationService',
                        '(ui/confirmation-dialog) Created a separate page for FluytConfirmationService and put the example configurator in there for better visibility',
                        '(docs) Moved Fluyt Components and Other Components into UI for better visibility and better categorization'
                    ]
                },
                {
                    type: 'Fixed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(fluyt/navigation) "tooltip" property to show tooltips on navigation items using MatTooltip'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(fluyt/navigation) Moved *ngIf directives into their own "ng-container" containers',
                        '(layouts) Hide the "fluyt-fullscreen" button on smaller devices since they don\'t support fullscreen',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(fluyt/drawer) Memory leak due to the animation player, thanks to Vadym Pidoplichko for coming up the issue and the solution.',
                        '(fluyt/navigation) Vertical navigation blocks scroll if it\'s destroyed while in "over" mode and opened',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(fluyt/fullscreen) [tooltip] & [iconTpl] inputs for customizing the trigger button',
                        '(fluyt/navigation) "target" property for setting the target attribute on external links',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(fluyt/navigation) First children of collapsable items don\'t have proper spacing at the top',
        ...
        // v13.0.3
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Changed',
                    list: [
                        '(fluyt/autogrow) BREAKING: Removed "fluytAutogrow" in favor of "matTextareaAutosize" since all of its problems solved, use [matTextareaAutosize] without any vertical padding on the textarea itself',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(FluytNavigation) Added support for new "isActiveMatchOptions" for Basic navigation items; https://github.com/angular/angular/pull/40303'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(FluytNavigation) Added a generic return type for "getComponent" method on FluytNavigationService',
                        '(FluytNavigation) Use the generic return type for "getComponent"',
                        '(fluyt) Fixed barrel exports',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(fluyt/masonry) Added a component for creating fast Masonry-like layouts'
                    ]
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(fluyt/fullscreen) Added fullscreen toggle component'
                    ]
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        'This is the new major version of the Fluyt and it\'s completely different from previous versions with no upgrade path',
