...
@Component({
    selector     : 'fluyt-date-range',
    templateUrl  : './date-range.component.html',
    styleUrls    : ['./date-range.component.scss'],
    encapsulation: ViewEncapsulation.None,
    exportAs     : 'fluytDateRange',
    providers    : [
        {
            provide    : NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => FluytDateRangeComponent),
            multi      : true
        }
    ]
})
export class FluytDateRangeComponent implements ControlValueAccessor, OnInit, OnDestroy
{
    ...
    @HostBinding('class.fluyt-date-range') private _defaultClassNames = true;
    ...
    openPickerPanel(): void
    {
        ...
        const overlayRef = this._overlay.create({
            panelClass      : 'fluyt-date-range-panel',
            backdropClass   : '',
            hasBackdrop     : true,
