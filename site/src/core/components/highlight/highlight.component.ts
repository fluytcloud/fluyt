...
import { FluytHighlightService } from 'core/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[fluyt-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'fluytHighlight'
})
export class FluytHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _fluytHighlightService: FluytHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._fluytHighlightService.highlight(this.code, this.lang));
