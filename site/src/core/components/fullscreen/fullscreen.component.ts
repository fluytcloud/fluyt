...
import { FSDocument, FSDocumentElement } from 'core/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'fluyt-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'fluytFullscreen'
})
export class FluytFullscreenComponent implements OnInit
{
