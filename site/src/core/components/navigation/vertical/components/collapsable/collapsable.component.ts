...
@Component({
    selector       : 'fluyt-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : fluytAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class FluytVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    {
        return {
            'fluyt-vertical-navigation-item-collapsed': this.isCollapsed,
            'fluyt-vertical-navigation-item-expanded' : this.isExpanded
        };
    }
    ...
    ngOnInit(): void
    {
        ...
        this._fluytVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._fluytVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._fluytVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._fluytVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _isChildrenOf(parent: FluytNavigationItem, item: FluytNavigationItem): boolean
    {
