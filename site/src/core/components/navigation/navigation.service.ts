...
export class FluytNavigationService {
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: FluytNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): FluytNavigationItem[] {
     ...
     */
    getFlatNavigation(navigation: FluytNavigationItem[], flatNavigation: FluytNavigationItem[] = []): FluytNavigationItem[] {
     ...
     * @param navigation
     */
    getItem(id: string, navigation: FluytNavigationItem[]): FluytNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return item;
            }
    ...
    getItemParent(
        id: string,
        navigation: FluytNavigationItem[],
        parent: FluytNavigationItem[] | FluytNavigationItem
    ): FluytNavigationItem[] | FluytNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
