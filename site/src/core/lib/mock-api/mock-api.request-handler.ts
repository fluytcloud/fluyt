...
import { FluytMockApiReplyCallback } from 'core/lib/mock-api/mock-api.types';

export class FluytMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: FluytMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: FluytMockApiReplyCallback): void
    {
        // Store the reply
