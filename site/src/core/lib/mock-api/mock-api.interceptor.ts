...
import { FluytMockApiService } from 'core/lib/mock-api/mock-api.service';

@Injectable({
    providedIn: 'root'
})
export class FluytMockApiInterceptor implements HttpInterceptor
{
    /**
     * Constructor
     */
    constructor(
        ...
        private _fluytMockApiService: FluytMockApiService
    )
    {
    }
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>>
    {
        ...
        const {
                  handler,
                  urlParams
              } = this._fluytMockApiService.findHandler(request.method.toUpperCase(), request.url);
